...
//    bRBK7=(float)(4-aRBK7*0.27);
    ...
    long test;
    long depth=13300;   //13400  //13200     //12400
    ...
    while (!myDxt->m_file.atEnd()){
        ...
        if(dataCheck==36371)
        {
            ...
            //this->getData(r);
//            if(firstRead==0){
//                test=myLisFile->addDataRec2(myLisFile->m_lAddrFisrtDataRec,depth,myLisFile->m_iLenFrameData,2,r);
//                firstRead=1;
//            }
//            else{
//                test=myLisFile->addDataRec2(test,depth,myLisFile->m_iLenFrameData,2,r);
//            }
        }
        step++;
...
void MainWindow::writeLineLas(float iCurDepth, QByteArray r)
{
    ...
    //xu ly
    //tt=32768+m_minIBK7;
    iIBK7=iIBK7-32768+1945+41; //32727;       //-30752
